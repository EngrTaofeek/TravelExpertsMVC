...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelExpertsData.Models.Admin", b =>
                {
                    ...
                    b.HasKey("AdminId")
                        .HasName("PK__Admin__719FE4E822C8EE62");
            ...
            modelBuilder.Entity("TravelExpertsData.Models.Agent", b =>
                {
                    ...
                    b.HasIndex(new[] { "AgencyId" }, "IX_Agents_AgencyId");

                    b.ToTable("Agents");
                });

            modelBuilder.Entity("TravelExpertsData.Models.AspNetRole", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsData.Models.AspNetRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsData.Models.AspNetUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TravelExpertsData.Models.AspNetUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TravelExpertsData.Models.AspNetUserLogin", b =>
                {
            ...
            modelBuilder.Entity("TravelExpertsData.Models.AspNetUserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TravelExpertsData.Models.PackagesProductsSupplier", b =>
                {
                    ...
                    b.HasIndex(new[] { "PackageId", "ProductSupplierId" }, "UQ__Packages__29CA8E951903138D")
                        .IsUnique();
            ...
            modelBuilder.Entity("TravelExpertsData.Models.ProductsPackage", b =>
                {
                    b.Property<int>("ProductPackageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("ProductPackageID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProductPackageId"));
                    ...
                    b.HasIndex(new[] { "PackageId" }, "IX_products_packages_PackageId");

                    b.HasIndex(new[] { "ProductId" }, "IX_products_packages_ProductId");

                    b.ToTable("products_packages");
                });
            ...
            modelBuilder.Entity("TravelExpertsData.Models.VwPackageProduct", b =>
                {
                    b.Property<int>("PackageId")
                        .HasColumnType("int");
                    ...
                    b.ToView("vw_PackageProducts", (string)null);
                });

            modelBuilder.Entity("AspNetUserRole", b =>
                {
                    b.HasOne("TravelExpertsData.Models.AspNetRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TravelExpertsData.Models.AspNetUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TravelExpertsData.Models.AspNetRoleClaim", b =>
                {
                    b.HasOne("TravelExpertsData.Models.AspNetRole", "Role")
            ...
            modelBuilder.Entity("TravelExpertsData.Models.AspNetUserClaim", b =>
                {
                    b.HasOne("TravelExpertsData.Models.AspNetUser", "User")
