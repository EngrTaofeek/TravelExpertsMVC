    ...
    public partial class identityUpdate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Admin__719FE4E822C8EE62", x => x.AdminID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PkgAgencyCommission = table.Column<decimal>(type: "money", nullable: true, defaultValue: 0.0m)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPackage", x => x.ProductPackageID);
                    table.ForeignKey(
                        name: "FK_Packages",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Packages__53E8ED99503AC85D", x => x.PackageProductSupplierId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Packages__29CA8E951903138D",
                table: "Packages_Products_Suppliers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_products_packages_PackageId",
                table: "products_packages",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_products_packages_ProductId",
                table: "products_packages",
                column: "ProductId");
