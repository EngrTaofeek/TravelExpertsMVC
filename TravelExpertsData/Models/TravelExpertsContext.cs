...
public partial class TravelExpertsContext : IdentityDbContext<User>
{
    ...
    public virtual DbSet<ProductsPackage> ProductsPackages { get; set; }
...
//        => optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=TravelExperts;Integrated Security=True; TrustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.PackageProductSupplierId).HasName("PK__Packages__53E8ED99503AC85D");
        ...
        {
            entity.HasKey(e => e.ProductPackageId).HasName("PK_ProductPackage");

            entity.HasOne(d => d.Package).WithMany(p => p.ProductsPackages).HasConstraintName("FK_Packages");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductsPackages)
                .OnDelete(DeleteBehavior.ClientSetNull)
